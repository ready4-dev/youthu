...
<!-- badges: start -->
[![R-CMD-check](https://github.com/ready4-dev/map2aqol/workflows/R-CMD-check/badge.svg)](https://github.com/ready4-dev/map2aqol/actions)
...
devtools::install_github("ready4-dev/map2aqol")
