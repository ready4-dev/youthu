...
# Calculating scores
To calculate AQoL 6D adolescent utility scores, a dataset with all twenty AQoL-6D questionnaire response items must be passed to the `add_adol6d_scores`{.R} function. In the following illustrative example, we use the [replication dataset](TA_Tools_Replication_DS.html) that is included in the youthu package.
