...
dictionary_tb %>%
<<<<<<< HEAD
  ready4show::print_table(output_type_1L_chr = "HTML", caption_1L_chr = "Data dictionary",  
...
raw_data_tb %>%
  head() %>%
<<<<<<< HEAD
  ready4show::print_table(output_type_1L_chr = "HTML", caption_1L_chr = "Replication dataset",  
                 use_lbls_as_col_nms_1L_lgl = T, 
