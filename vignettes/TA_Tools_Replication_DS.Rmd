...
```{r ddic}
dictionary_tb %>%
  ready4u::print_table_xx(output_type_1L_chr = "HTML", caption_1L_chr = "Data dictionary",  
...
raw_data_tb %>%
  head() %>%
  ready4u::print_table_xx(output_type_1L_chr = "HTML", caption_1L_chr = "Replication dataset",  
