...
We can pass the values of the `PHQ9_total` and `SOFAS_total` variables in our dataset to the functions for creating instances of the `firstbounce_phq9` and `firstbounce_sofas` classes respectively. If no error message is thrown, then the data is consistent with the requirements for variable.
