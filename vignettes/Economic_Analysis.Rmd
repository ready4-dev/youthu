...
```{r}
summary((econ_cmprsn_ds_tb %>% dplyr::filter(study_arm_chr == "Control" & round == "Baseline"))[3:7])
```
```{r}
summary((econ_cmprsn_ds_tb %>% dplyr::filter(study_arm_chr == "Intervention" & round == "Baseline"))[3:7])
```
```{r}
summary((econ_cmprsn_ds_tb %>% dplyr::filter(study_arm_chr == "Control" & round == "Follow-up"))[3:7])
```
```{r}
summary((econ_cmprsn_ds_tb %>% dplyr::filter(study_arm_chr == "Intervention" & round == "Follow-up"))[3:6])
```
...
```{r}
econ_cmprsn_ds_tb <- add_aqol6d_predn_to_ds(data_tb = econ_cmprsn_ds_tb,
                                   model_mdl = model_mdl,
