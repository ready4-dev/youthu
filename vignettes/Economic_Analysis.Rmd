...
rename_lup <- tibble::tibble(old_name_chr = selected_cols_chr, new_name_chr = c(costs_var_nm_1L_chr, benefits_var_nm_1L_chr, replacements_chr))
...
summary_tb <- ds_tb[indices,] %>% 
  ...
  dplyr::mutate(ICER = (!!rlang::sym(new_nms_ls[[1]][1]) - !!rlang::sym(new_nms_ls[[1]][2])) /
                  (!!rlang::sym(new_nms_ls[[2]][1]) - !!rlang::sym(new_nms_ls[[2]][2]))) %>%
