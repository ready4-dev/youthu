...
ready4fun::make_pkg_desc_ls(pkg_title_1L_chr = "Map Measures Routinely Collected in Mental Health Services To AQOL 6D Health Utility",
  ...
  The documentation for this package has been automatically generated by the ready4fun package and is therefore quite rudimentary. Human authored documentation will follow in 2021.",
                            ...
                            urls_chr = c("https://ready4-dev.github.io/map2aqol/",
  ...
  ready4fun::write_pkg_setup_fls(incr_ver_1L_lgl = F,
                                 ...
                                 path_to_pkg_logo_1L_chr = "../../../../../Documentation/Images/map2aqol-logo/default.png",
                                 github_repo = "ready4-dev/map2aqol",
...
ready4use::ready4_dv_import_lup() %>%
  ...
  ready4fun::write_and_doc_ds(db_1L_chr = "mdls_smry_tb",
                              title_1L_chr = "Summary coefficients for map2aqol transfer to utility models",
                              desc_1L_chr = "A summary of the models included in the map2aqol package that can be used to predict adolescent AQoL6D. Note this summary is a placeholder as all models have been estimated from synthetic data.",
                              abbreviations_lup = abbreviations_lup,
                              pkg_dss_tb = pkg_dss_tb)
